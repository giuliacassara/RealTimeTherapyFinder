...
# mutation_finder.py
# Readaptation: Giulia Cassara' (giulia@hyperable.io), Marco Spaziani Brunella (marco@hyperable.io)
""" Description
...
#mutation_finder_home = '/home/giulia/lavoro/GenomeUp/MutationFinder/'
